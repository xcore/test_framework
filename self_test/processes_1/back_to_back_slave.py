...
output = [
    ...
    (random.random() * 5,  "PTP Role: Slave"),
    (random.random() * 1,  "PTP sync locked"),
    ...
    (random.random() * 1,  "  2 -> 2"),
    (random.random() * 1,  "  3 -> 3"),
    (random.random() * 1,  "Media output 0 locked: 74 samples shorter"),
    (random.random() * 1,  "Media output 1 locked: 74 samples shorter"),
    (random.random() * 1,  "Media output 2 locked: 74 samples shorter"),
    (random.random() * 1,  "Media output 3 locked: 74 samples shorter"),
]
